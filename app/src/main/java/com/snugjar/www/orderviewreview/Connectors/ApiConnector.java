...
public class ApiConnector {
    ...
    public JSONArray GetAvailableSupermarkets(String country) {
        ...
        try {
            URL url = new URL(Constants.BASE_URL_LOGIC + "getAvailableFoodJoints.php?country=" + country);
            urlConnection = (HttpsURLConnection) url.openConnection();
    ...
    public JSONArray GetSlidingImages(String country) {
        ...
        try {
            URL url = new URL(Constants.BASE_URL_LOGIC + "getSlidingImages.php?country=" + country);
            urlConnection = (HttpsURLConnection) url.openConnection();
    ...
    public JSONArray GetAllBranches(String foodjointID) {
        StringBuilder result = new StringBuilder();
        JSONArray jsonArray = null;
        HttpsURLConnection urlConnection = null;
    ...
    public String GetOrderID(String supermarketName) {
        ...
        try {
            URL url = new URL(Constants.BASE_URL_LOGIC + "getOrderID.php?foodjointName=" + supermarketName);
            urlConnection = (HttpsURLConnection) url.openConnection();
    ...
    //used to update user information in the database when a user changes it
    public String DeleteUser(String SpersonID) {
        StringBuilder result = new StringBuilder();
        HttpsURLConnection urlConnection = null;
        String response = null;
